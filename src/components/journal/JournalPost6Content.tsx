  ...
  return (
    <div className="prose prose-lg max-w-none">
      <p className="lead text-xl text-muted-foreground mb-8">
        Паспорт — главный документ каждого гражданина России. Его замена — 
        обязательная процедура в определённых ситуациях. Но что будет, если 
        не поменять паспорт вовремя? Разбираемся в сроках, штрафах и последствиях.
      </p>
