...
const Hero = () => {
  ...
  return (
    <section className="relative min-h-screen flex items-center justify-center overflow-hidden bg-gradient-to-br from-primary/5 via-background via-50% to-secondary/5 pt-12" aria-label="Главный баннер">
