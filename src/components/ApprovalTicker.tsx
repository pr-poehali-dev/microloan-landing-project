...
const ApprovalTicker = () => {
  ...
  const names = ["Александр", "Елена", "Дмитрий", "Ольга", "Сергей", "Наталья", "Андрей", "Мария", "Иван", "Татьяна", "Максим", "Анна", "Владимир", "Светлана", "Алексей", "Юлия", "Денис", "Екатерина", "Павел", "Ирина", "Роман", "Виктория", "Константин", "Дарья", "Артём"];
  const cities = ["Москва", "Санкт-Петербург", "Новосибирск", "Екатеринбург", "Казань", "Нижний Новгород", "Челябинск", "Самара", "Омск", "Ростов-на-Дону", "Уфа", "Красноярск", "Воронеж", "Пермь", "Волгоград", "Краснодар", "Саратов", "Тюмень", "Тольятти", "Ижевск", "Барнаул", "Ульяновск", "Иркутск", "Хабаровск", "Ярославль", "Владивосток", "Махачкала", "Томск", "Оренбург", "Кемерово"];
  const mfos = ["Займер", "МигКредит", "Быстроденьги", "Вебзайм", "ДоЗарплаты", "MoneyMan", "Creditplus", "Lime", "Ezaem", "Turbozaim", "Creditter", "CashToYou", "Zaymer"];
